...
WHERE g.name IN (N'$(APP_USER)', N'almirante_app_role') AND p.permission_name <> N'CONNECT' AND p.class IN (0, 1, 3) AND p.minor_id = 0;
...
-- Conferência: todas as colunas devem ser 0.
